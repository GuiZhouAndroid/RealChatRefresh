package com.zs.itking.realchatrefresh.fragment;
...
import com.zs.itking.realchatrefresh.adapter.BaseRecyclerAdapter;
import com.zs.itking.realchatrefresh.adapter.SmartViewHolder;
import com.zs.itking.realchatrefresh.util.DynamicTimeFormat;
...
public class InstantPracticeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_practice_instant, container, false);
        initView(view);
        return view;
    }
    ...
    private void initView(View view) {
        view.findViewById(R.id.send).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(getActivity(), "您点击了发送", Toast.LENGTH_SHORT).show();
            }
        });
    }
